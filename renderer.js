...
const renderInventory = (inventory) => {
  ...
  for(item in inventory.contents){
    ...
    document.querySelector("#bag").innerHTML += `<div id="item" data-pos="${item}" data-item='${JSON.stringify(inventory.contents[item])}'><img src="${inventory.contents[item].image}" height="100%" width="100%"></div>`;
  }
  return true;
};
